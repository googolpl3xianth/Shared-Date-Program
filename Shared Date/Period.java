...
{        
   ...
   public Period(String newName, int datesTimes[][][], ArrayList<String>[] datesTypes) //Assigned Period
   {
      name = newName;
   ...
   public void setTeacher(int index)
   {
   ...
   public ArrayList<Person> findSharedPeople(ArrayList<Person> availablePeople, ArrayList<Person> peopleList) // returns an array of the people availablePeople and peopleList share
   {
      ArrayList<Person> tempList = new ArrayList<Person>();
      for(int i = 0; i < availablePeople.size(); i++)
      {
         if(containsPerson(peopleList, availablePeople.get(i)) != -1)
         {
            tempList.add(availablePeople.get(i));
         }
      }
      return tempList;
   }
